        ...
        <div id="box" style=" width: 400px; height: 600px; margin: auto">
          <form action="save.php" method="post" >
            ...
            <input type='hidden'  name='studentID' id='studentID' value='<?php echo $row['ID'];
             ?>' /></td>        
            <input id="stud_name" type="text" name="stud_name" value="<?php echo $row['STUD_NAME']; ?>" /><br /><br />
            <input id="password" type="text" name="password" value="<?php echo $row['STUD_PASSWORD']; ?>" /><br /><br />
